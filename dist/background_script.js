...
const constants_1 = __webpack_require__(/*! ../data/constants */ "./src/data/constants.ts");
let port = constants_1.conf.port;
let baseURL = `${constants_1.conf.baseURL}:${port}`;
...
chrome.runtime.onMessage.addListener((message) => {
    switch (message.command) {
        case constants_1.Commands.get_server_status: {
            axios_1.default
                .get(baseURL)
                .then(response => {
        ...
        case constants_1.Commands.send_to_buffer: {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.Commands = exports.conf = void 0;
let conf = {
    port: 8000,
...
var Commands;
(function (Commands) {
    Commands[Commands["get_server_status"] = 0] = "get_server_status";
    Commands[Commands["get_lead_count"] = 1] = "get_lead_count";
    Commands[Commands["send_to_buffer"] = 2] = "send_to_buffer";
})(Commands || (Commands = {}));
